...
heartbeatthread(void *x)
{
  ...
  config::config(std::string _first, std::string _me, config_view_change *_vc, int sockfd) 
: myvid (0), first (_first), me (_me), vc (_vc), _sockfd(sockfd)
{
  ...
  acc = new acceptor(this, me == _first, me, ost.str(), _sockfd);
  pro = new proposer(this, acc, me, _sockfd);
